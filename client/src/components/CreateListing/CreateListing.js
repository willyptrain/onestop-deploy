...
class CreateListing extends Component {
    ...
    constructor(props) {
        ...
        this.state = {'selectedSport': this.sportList[0], "tradeOrSell": "Trade", "year":this.yearList[0],
    ...
    createAListing = (event) => {
        ...
        axios.post(`/api/listing/create/${token}`, {
            ...
            'player_name': 'player' in this.state ? this.state['player'] : "",
    ...
    render() {
        if (this.state.id) {
            return <Redirect {...this.state} url={`/view_listing/${this.state.id}`} />
          }
        return (<div className="listing-container">
            ...
            <div className="form-root">    
               {/* <form onSubmit={this.createAListing} id="listing-form"> */}
                <TextField form="listing-form" className="listing-full-label"
                    ...
                    onKeyUp={this.typePlayer}
                    />
            <TextField form="listing-form" class="standard-select-currency-native" value={this.state['selectedSport']} 
            ...
            <TextField form="listing-form" class="standard-select-currency-native" value={this.state['tradeOrSell']} 
            ...
            <TextField form="listing-form" class="standard-select-currency-native" value={this.state['year']} 
            ...
            <TextField form="listing-form" id="standard-select-currency-native" value={this.state['manufacturer']} 
