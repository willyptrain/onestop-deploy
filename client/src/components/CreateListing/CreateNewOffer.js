...
class CreateNewOffer extends Component {
    ...
    constructor(props) {
        ...
        this.state = {'loading': false, 'edit':props.edit,'images': [], 'new_img_paths':[],'img_paths':[], 'posted_card_id' : props.posted_card_id, 'type': props.type, 
                    'checked': []}; 
    ...
    createOffer = (event) => {
        ...
        form_data.append('tradeOrSell', "Trade");
        form_data.append('price', 0);
        form_data.append('posted_card_id', this.state['posted_card_id']);
        ...
        this.state['images'].forEach(file => {
            ...
            axios.post(`/api/offers/create/new_card/${this.state['posted_card_id']}/${token}`, form_data, {
                headers: {
    ...
    render() {
        ...
        if (this.state.redirectUrl && this.state.submitted == true) {
    ...
    if(!this.state['loading']) {
        ...
        <Card className="listing-container overflowScroll">
                ...
                <CardHeader title="Create An Offer" titleTypographyProps={{className:"mont-text"}} subheader="Post a new card to make an offer with" />
                <CardContent>
                    ...
                    <Button type="submit" onClick={this.createOffer} variant="contained">Make Offer</Button>
